// Hand-rolled inline SVGs (the app uses no icon library). Stroke-based, sized to
// the surrounding text via the `size` prop, inheriting colour via currentColor.
// Paths mirror Tabler's ti-sparkles / ti-x / ti-clipboard.
